...
enum Environment {}
  ...
  extension Environment {
    ...
    /// Checks the `LOCAL_LAMBDA_SERVER_ENABLED` environment variable and returns its Boolean value.
    ///
    /// Defaults to `false`.
...
extension Environment {
  ...
  /// Checks the `DEBUG_LOG_ENABLED` environment variable and returns its Boolean value.
  ///
  /// Defaults to `false`.
